...
class module(ModuleType):
    ...
    def get_tls_base_via_errno_location(self) -> int:
        ...
        if pwndbg.gdb.arch.current not in ("x86-64", "i386", "arm"):
    ...
    def address(self) -> int:
        ...
        if pwndbg.gdb.arch.current not in ("x86-64", "i386", "aarch64", "arm"):
            # Not supported yet
            return 0
        ...
        is_valid_tls_base = (
            pwndbg.vmmap.find(tls_base) is not None and tls_base % pwndbg.gdb.arch.ptrsize == 0
        )
