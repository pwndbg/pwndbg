...
from capstone import CS_ARCH_ARM, CS_ARCH_ARM64, CS_ARCH_MIPS, CS_ARCH_PPC, CS_ARCH_RISCV, CS_ARCH_SPARC, CS_ARCH_X86, CS_MODE_16, CS_MODE_32, CS_MODE_64, CS_MODE_ARM, CS_MODE_MCLASS, CS_MODE_MIPS32, CS_MODE_MIPS32R6, CS_MODE_MIPS64, CS_MODE_RISCV32, CS_MODE_RISCV64, CS_MODE_RISCVC, CS_MODE_THUMB, CS_MODE_V9
import pwnlib
...
from pwndbg.lib.abi import ABI, DEFAULT_ABIS, SIGRETURN_ABIS, SYSCALL_ABIS, SyscallABI
from pwndbg.lib.arch import PWNDBG_SUPPORTED_ARCHITECTURES_TYPE, PWNLIB_ARCH_MAPPINGS
...
class PwndbgArchitecture:
    ...
    def update(self, ptrsize: int, endian: EndianType) -> None:
        ...
        # TODO - allow a way for this to be set in stone
...
class MipsArch(PwndbgArchitecture):
    ...
    def get_capstone_constants(self, address: int) -> Tuple[int,int]:
        ...
        if pwndbg.dbg.is_gdblib_available() and "isa32r6" in gdb.newest_frame().architecture().name():
