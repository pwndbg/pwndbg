...
def find_address_with_pthread_self() -> int:
    ...
    # For i386 and x86-64, the return value of the pthread_self() is the address of TLS,
    # because the value is self reference of the TLS: https://elixir.bootlin.com/glibc/glibc-2.37/source/nptl/pthread_create.c#L671
