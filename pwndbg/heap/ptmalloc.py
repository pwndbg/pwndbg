...
class HeuristicHeap(Heap):
    ...
    def main_arena(self):
        ...
        if not self._main_arena_addr:
            if pwndbg.glibc.get_version() < (2, 34) and pwndbg.gdb.arch.current != "arm":
    ...
    def thread_arena(self):
        ...
        if thread_arena_via_config > 0:
            ...
            if tls_base:
                ...
                else:  # elif pwndbg.gdb.arch.current in ("aarch64", "arm"):
    ...
    def thread_cache(self):
        ...
        if self.has_tcache():
            ...
            elif pwndbg.gdb.arch.current in ("aarch64", "arm"):
            ...
            is_offset_valid = (
                is_offset_valid and self._thread_cache_offset % pwndbg.gdb.arch.ptrsize == 0
            )
            ...
            first_chunk_size = pwndbg.gdb.arch.unpack(
