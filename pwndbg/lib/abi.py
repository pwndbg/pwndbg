...
linux_loongarch64 = ABI(("a0", "a1", "a2", "a3", "a4", "a5", "a6", "a7"), 8, 0) # added
...
linux_loongarch64_syscall = SyscallABI(("a7", "a0", "a1", "a2", "a3", "a4", "a5", "a6"), 8, 0) # added
...
linux_s390x_syscall = SyscallABI(("r1", "r2", "r3", "r4", "r5", "r6"),8,0,) # added
...
linux_loongarch64_sigreturn = SigreturnABI(("a7",), 8, 0)  # added
linux_s390x_sigreturn = SigreturnABI(("r1",), 8, 0) # added
...
DEFAULT_ABIS: dict[tuple[int, str, str], ABI] = {
    ...
    (64, 'loongarch64', 'linux'): linux_loongarch64, # added
    ...
    (64, "s390x", "linux"): linux_s390x, # added
}
...
SYSCALL_ABIS: dict[tuple[int, str, str], SyscallABI] = {
    ...
    (64, 'loongarch64', 'linux'): linux_loongarch64_syscall, # added
    ...
    (64, "s390x", "linux"): linux_s390x_syscall, # added
}
...
SIGRETURN_ABIS: dict[tuple[int, str, str], SigreturnABI] = {
    ...
    (64, "loongarch64", "linux"): linux_loongarch64_sigreturn,  # added
    (64, "s390x", "linux"): linux_s390x_sigreturn, # added
}
