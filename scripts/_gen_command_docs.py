...
def verify_existence(filenames: list[str]) -> bool:
...
if just_verify:
    ...
    err = verify_existence(markdowned.keys())
    if err:
        print("To add missing files please run ./scripts/generate_docs.sh.")
        print("To remove extra files please delete them by hand.")
        exit(555)
