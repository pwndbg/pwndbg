...
def convert_to_markdown(scope: str, debugger_to_params: Dict[str, list[ExtractedParam]]) -> str:
    ...
    autogen_warning = "<!-- THIS WHOLE FILE IS AUTOGENERATED. DO NOT MODIFY IT. See scripts/generate-docs.sh -->"
...
def convert_all_to_markdown(extracted: list[Tuple[str, Dict[str, list[ExtractedParam]]]]) -> Dict[str, str]:
    result = {}
