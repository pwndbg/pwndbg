...
def test_heap_bins(start_binary):
    ...
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("tcache_size")
    tcache_size = allocator._request2size(pwndbg.aglib.memory.u64(addr))
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("tcache_count")
    tcache_count = pwndbg.aglib.memory.u64(addr)
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("fastbin_size")
    fastbin_size = allocator._request2size(pwndbg.aglib.memory.u64(addr))
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("fastbin_count")
    fastbin_count = pwndbg.aglib.memory.u64(addr)
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("smallbin_size")
    smallbin_size = allocator._request2size(pwndbg.aglib.memory.u64(addr))
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("smallbin_count")
    smallbin_count = pwndbg.aglib.memory.u64(addr)
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("largebin_size")
    largebin_size = allocator._request2size(pwndbg.aglib.memory.u64(addr))
    addr = pwndbg.aglib.symbol.lookup_global_symbol_addr("largebin_count")
