...
|-f|--function|Disassemble an entire function. Takes an expression (such as a function name or address) and disassembles the function surrounding the evaluated address.|
