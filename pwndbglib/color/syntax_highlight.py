...
try:
    ...
    from pwndbglib.color.lexer import PwntoolsLexer
except ImportError:
    pygments = None

pwndbglib.config.Parameter('syntax-highlight', True, 'Source code / assembly syntax highlight')
...
@pwndbglib.config.Trigger([style])
def check_style():
    global formatter
    try:
        ...
        from pwndbglib.commands.context import get_highlight_source
