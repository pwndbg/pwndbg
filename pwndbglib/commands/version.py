...
def all_versions():
    ...
    pwndbg_str   = 'Pwndbg:   %s' % pwndbglib.__version__
    ...
    ida_versions = pwndbglib.ida.get_ida_versions()
...
@pwndbglib.commands.ArgparsedCommand("Displays gdb, python and pwndbg versions.")
def version():
    """
    Displays gdb, python and pwndbg versions.
    """
...
@pwndbglib.commands.ArgparsedCommand(bugreport_parser)
