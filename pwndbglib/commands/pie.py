...
def get_exe_name():
    ...
    """
    path = pwndbglib.auxv.get().get('AT_EXECFN')
    ...
    real_path = pwndbglib.file.readlink(path)
...
@pwndbglib.commands.QuietSloppyParsedCommand #TODO should this just be an alias or does the QuietSloppy have an effect?
@pwndbglib.commands.OnlyWhenRunning
def brva(*args):
    """Alias for breakrva."""
