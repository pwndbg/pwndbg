...
verbose = pwndbglib.config.Parameter('exception-verbose', False, 'whether to print a full stacktrace for exceptions raised in Pwndbg commands')
debug = pwndbglib.config.Parameter('exception-debugger', False, 'whether to debug exceptions raised in Pwndbg commands')
...
@pwndbglib.config.Trigger([verbose, debug])
def update():
    if verbose or debug:
